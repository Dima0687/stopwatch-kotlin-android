...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val settingBtn = findViewById<Button>(R.id.settingsButton)
        ...
        settingBtn.setOnClickListener {
            val dialogView = LayoutInflater.from(this).inflate(R.layout.dialog_setttings, null)
            ...
            AlertDialog.Builder(this)
                ...
                .setPositiveButton("OK") { _, _ ->
                    ...
                    upperLimit = inputText.toIntOrNull()
                }
    ...
    private fun createNotificationChannel() {
        ...
        val channel = NotificationChannel("de.eisner", name, importance)
        val notificationManager = getSystemService(NOTIFICATION_SERVICE) as NotificationManager
        notificationManager.createNotificationChannel(channel)
    }

    private fun showNotification() {
        val builder = NotificationCompat.Builder(this, "de.eisner")
